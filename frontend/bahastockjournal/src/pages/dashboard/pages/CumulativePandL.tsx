...
const CumulativePandL = ({ data }: ChartsLinePLProps) => {

    const { isLayoutSidebarOpen } = useLayoutSidebar();
    const { theme } = useTheme();

    return (
        <div className='bgS-LD text-LD flex-1 min-w-[550px] h-[328px] rounded-lg relative font-semibold '>
            ...
            <div className='flex items-center p-3 gap-1'>
                ...
                <p className='title-text'>Cumulative P&L</p>
...
export default CumulativePandL