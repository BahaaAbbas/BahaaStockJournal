...
import { ReportsChartProps } from "../../../Types/Reports";
...
const ReportsChartCard: FC<ReportsChartProps> = ({ title, chartType, data, dataKey }) => {

    const { theme } = useTheme();
    const { isLayoutSidebarOpen } = useLayoutSidebar();
    const chartWidth = isLayoutSidebarOpen ? 530 : 600;

    return (
        <div className='bgS-LD text-LD min-w-[530px] h-[328px] rounded-lg relative font-semibold'>
            {/* Icon & title */}
